...
public final class PositionFixture {
    ...
    public static final Position B6 = new Position(new File('b'), new Rank(6));
    public static final Position B7 = new Position(new File('b'), new Rank(7));

    public static final Position B8 = new Position(new File('b'), new Rank(8));
    ...
    public static final Position C4 = new Position(new File('c'), new Rank(4));
    ...
    public static final Position C8 = new Position(new File('c'), new Rank(8));

    public static final Position D1 = new Position(new File('d'), new Rank(1));
    public static final Position D2 = new Position(new File('d'), new Rank(2));
    ...
    public static final Position F1 = new Position(new File('f'), new Rank(1));
    ...
    public static final Position F4 = new Position(new File('f'), new Rank(4));
    public static final Position G2 = new Position(new File('g'), new Rank(2));
    public static final Position G4 = new Position(new File('g'), new Rank(4));
